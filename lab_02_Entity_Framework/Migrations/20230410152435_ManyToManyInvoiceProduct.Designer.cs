...
namespace JakubBarberEFProducts.Migrations
{
    ...
    [Migration("20230410152435_ManyToManyInvoiceProduct")]
    partial class ManyToManyInvoiceProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceProduct", b =>
                {
                    b.Property<int>("ProductsInvoiceID")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ProductsProductID")
                        .HasColumnType("INTEGER");

                    b.HasKey("ProductsInvoiceID", "ProductsProductID");
            ...
            modelBuilder.Entity("InvoiceProduct", b =>
                {
                    b.HasOne("JakubBarberEFProducts.Invoice", null)
                        .WithMany()
                        .HasForeignKey("ProductsInvoiceID")
